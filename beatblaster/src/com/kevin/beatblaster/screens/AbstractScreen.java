...
public abstract class AbstractScreen implements Screen {
	...
	protected final BeatBlaster game;
	protected final Stage stage;
	protected final ActionResolverAndroid actionResolver;
	...
	@Override
	public void show() {
		Gdx.app.log(BeatBlaster.LOG, "Showing screen: " + getName());
	...
	public void resize(int width, int height) {
		Gdx.app.log(BeatBlaster.LOG, "Resizing screen: " + getName() + " to: "
				+ width + " x " + height);
	}
	...
	@Override
	public void hide() {
		Gdx.app.log(BeatBlaster.LOG, "Hiding screen: " + getName());
	...
	@Override
	public void pause() {
		Gdx.app.log(BeatBlaster.LOG, "Pausing screen: " + getName());
	}

	@Override
	public void resume() {
		Gdx.app.log(BeatBlaster.LOG, "Resuming screen: " + getName());
	}
