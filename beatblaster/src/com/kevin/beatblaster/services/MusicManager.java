package com.kevin.beatblaster.services;
...
public class MusicManager implements Disposable {
	 ...
	 */
	public class BeatBlasterMusic {

		private String fileName;
		private Music musicResource;

		public BeatBlasterMusic(String fileName) {
	 ...
	 */
	private BeatBlasterMusic musicBeingPlayed;
	 ...
	 */
	public void play(BeatBlasterMusic music) {
		...
		// do some logging
		Gdx.app.log(BeatBlaster.LOG, "Playing music: " + music.getFileName());
	...
	public void stop() {
		if (musicBeingPlayed != null) {
			Gdx.app.log(BeatBlaster.LOG, "Stopping current music");
	...
	public void setVolume(float volume) {
		Gdx.app.log(BeatBlaster.LOG, "Adjusting music volume to: " + volume);
	 ...
	 */
	public void dispose() {
		Gdx.app.log(BeatBlaster.LOG, "Disposing music manager");
		stop();
	}
}
